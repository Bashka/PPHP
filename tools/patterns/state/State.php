...
/**
 * Дочерние классы данного класса являются состояниями некоторого объекта-контекста, позволяя изменять его поведение через делегирование вызова.
...
abstract class State{
  /**
   * @var StatesContext Ссылка на контекст состояния.
   */
  protected $context;
