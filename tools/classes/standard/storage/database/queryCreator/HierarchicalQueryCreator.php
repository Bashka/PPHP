 ...
 */
class HierarchicalQueryCreator{
  /**
   ...
   * @throws \PPHP\tools\patterns\database\identification\OIDException Выбрасывается в случае, если заданный узел не имеет идентификатора.
   */
  public function createUpdateChildQuery(\PPHP\tools\classes\standard\essence\structures\hierarchical\HierarchicalEntity $object){
    if(!$object->isOID()){
      throw new \PPHP\tools\patterns\database\identification\OIDException();
    }
