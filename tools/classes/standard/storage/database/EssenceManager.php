 ...
 */
abstract class EssenceManager implements \PPHP\tools\patterns\singleton\Singleton{
   ...
   */
  protected function addEssence(\PPHP\tools\patterns\database\LongObject $essence){
    $this->setDataMapper();
   ...
   */
  protected function removeEssence(\PPHP\tools\patterns\database\LongObject $essence){
    $this->setDataMapper();
   ...
   */
  protected function removeAssoc(\PPHP\tools\patterns\database\associations\LongAssociation $assoc){
    $this->setDataMapper();
   ...
   * @return boolean true - если удаление успешно.
   */
  protected function compositeRemoval(\PPHP\tools\patterns\database\associations\LongAssociation $assoc, array $gettersEssence){
    $this->setDataMapper();
    $this->dataMapper->recoverAssoc($assoc);
    foreach($assoc as $link){
   ...
   */
  protected function findingRemoveAssoc(\PPHP\tools\patterns\metadata\reflection\ReflectionClass $assocClass, \PPHP\tools\patterns\metadata\reflection\ReflectionProperty $key, \PPHP\tools\patterns\database\LongObject $essence){
    $this->setDataMapper();
   ...
   * @return boolean true - в случае успеха.
   */
  protected function findingCompositeRemoval(\PPHP\tools\patterns\metadata\reflection\ReflectionClass $assocClass, \PPHP\tools\patterns\metadata\reflection\ReflectionProperty $key, \PPHP\tools\patterns\database\LongObject $essence, array $gettersEssence){
    $this->setDataMapper();
   ...
   */
  protected function updateEssence(\PPHP\tools\patterns\database\LongObject $essence){
    $this->setDataMapper();
   ...
   */
  protected function recoverEssence(\PPHP\tools\patterns\database\LongObject $essence){
    $this->setDataMapper();
   ...
   */
  protected function findEssence(\PPHP\tools\patterns\database\LongObject &$essence, array $requiredProperties){
    $this->setDataMapper();
   ...
   */
  protected function findEssences(\PPHP\tools\patterns\metadata\reflection\ReflectionClass $essenceClass, array $requiredProperties){
    $this->setDataMapper();
   ...
   */
  protected function recoverComponents(\PPHP\tools\patterns\database\associations\LongAssociation $assoc, \PPHP\tools\patterns\metadata\reflection\ReflectionMethod $getterEssence){
    $this->setDataMapper();
    $this->dataMapper->recoverAssoc($assoc);
   ...
   */
  protected function recoverFindAssoc(\PPHP\tools\patterns\metadata\reflection\ReflectionClass $assocClass, \PPHP\tools\patterns\metadata\reflection\ReflectionProperty $key, \PPHP\tools\patterns\database\LongObject $essence){
    $this->setDataMapper();
   ...
   * @return \SplObjectStorage Множество восстановленных сущностей.
   */
  protected function recoverFindComponents(\PPHP\tools\patterns\metadata\reflection\ReflectionClass $assocClass, \PPHP\tools\patterns\metadata\reflection\ReflectionProperty $key, \PPHP\tools\patterns\database\LongObject $essence, \PPHP\tools\patterns\metadata\reflection\ReflectionMethod $getterEssence){
    $this->setDataMapper();
