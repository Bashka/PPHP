...
/**
 * Класс-обертка служит для представления и верификации идентификаторов сессий пользователей.
 * Допустимый тип: только латинские буквы любого регистра, цифры и знак минуса (-).
 * @author Artur Sh. Mamedbekov
 * @package PPHP\tools\classes\standard\baseType\special
 */
class SessionID extends baseType\Wrapper{
  /**
